...
import cz.vratislavjindra.alzacasestudy.feature_products.data.remote.dto.GetProductDetailResponse
...
interface ProductApi {
    ...
    suspend fun getProductsByCategory(
        @Body requestBody: GetProductsByCategoryRequest
    ): GetProductsResponse

    @GET("v13/product/{productId}")
    suspend fun getProductDetail(@Path("productId") productId: Int): GetProductDetailResponse
}